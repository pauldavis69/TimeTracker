    ...
    <div id="adminedit">
        ...
        <fieldset>
            ...
            <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" OnFinishButtonClick="Wizard_FinishButton_Click"
                ContinueDestinationPageUrl="TimeEntry.aspx" OnCreatedUser="CreateUserWizard1_CreatedUser" BackColor="#F7F7DE" BorderColor="#CCCC99" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="10pt">
                <WizardSteps>
                ...
                <TitleTextStyle CssClass="header-lightgray" BackColor="#6B696B" Font-Bold="True" ForeColor="#FFFFFF" />
